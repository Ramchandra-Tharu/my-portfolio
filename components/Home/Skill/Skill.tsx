          ...
          skills.map((skill, i) => {
            return (
              <Tilt key={skill.name} scale={1.5} transitionSpeed={400}>
                <div
                  data-aos='flip-up' data-aos-anchor-placement='top-center' data-aos-delay={i * 100}
                  className="bg-[#14134145] w-40 h-48 text-center rounded-3xl flex flex-col items-center justify-center shadow-lg transition scale-105">
